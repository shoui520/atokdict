...
The `dsy-region3-extra-run-links` command checks whether extra run indexes and extra run value
ordinals recur as low words in region-3 prefix zones and fit in the region-1 record-index range.
