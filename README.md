...
python -m atokdict dsy-dsz-active-classes /path/to/FILE.DSY
python -m atokdict dsy-dsz-record-profile /path/to/FILE.DSY
...
python -m atokdict dsy-region3-extra-runs /path/to/FILE.DSY
python -m atokdict dsy-region3-extra-run-links /path/to/FILE.DSY
